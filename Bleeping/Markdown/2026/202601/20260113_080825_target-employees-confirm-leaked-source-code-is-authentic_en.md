...
This includes tooling built around a customized CI/CD platform called Vela—a fact Target has [also previously mentioned publicly](https://archive.md/u55rZ), as well as the use of supply-chain infrastructure such as JFrog Artifactory, as also evident from [third-party business intel](https://archive.md/5r3WV).
...
A current employee, who requested anonymity, also shared a screenshot of a company-wide Slack message in which a senior product manager announced a sudden security change, a day after BleepingComputer had contacted Target:
...
However, security researcher [Alon Gal](https://www.linkedin.com/in/alon-gal-utb/), CTO and co-founder of Hudson Rock, told BleepingComputer that his team has identified a Target employee workstation that was compromised by infostealer malware in late September 2025 and had extensive access to internal services.
