# NCSC's ‘Proactive Notifications’ cảnh báo các tổ chức về lỗ hổng trong các thiết bị bị phơi bày

![NCSC's ‘Proactive Notifications’ cảnh báo các tổ chức về lỗ hổng trong các thiết bị bị phơi bày](https://www.bleepstatic.com/content/hl-images/2025/03/20/UK.jpg)
...
“Scanning and notifications will be based on external observations such as the version number publicly advertised by the software,” [NCSC giải thích](https://www.ncsc.gov.uk/information/proactive-notifications-service), adding that this activity is “tuân thủ Computer Misuse Act.”

The agency highlights that the emails sent through this service originate from _netcraft.com_ addresses, do not include attachments, and do not request payments, personal, or other type of information.
...
Organizations are strongly [được khuyến khích đăng ký](https://www.ncsc.gov.uk/section/active-cyber-defence/early-warning) for the more mature ['Early Warning' service](https://www.bleepingcomputer.com/news/security/uk-cybersecurity-center-sent-33-million-alerts-to-companies/) to receive timely notifications for security issues affecting their networks.
